...
export default function KategoriProductPage() {
  ...
  const fetchDashboardStats = async () => {
    try {
      ...
      const resSeller = await fetch('/api/api/sellers', {
        method: 'GET',
        headers: { 'Authorization': `Bearer ${token}` }
      });
      ...
      const resBuyer = await fetch('/api/api/users/count-buyers', {
        method: 'GET',
        headers: { 'Authorization': `Bearer ${token}` }
      });
                                ...
                                <div 
                                  onClick={() => {
                                    Swal.fire({
                                      ...
                                      imageUrl: `/api/uploads/categories/${category.image}`,
