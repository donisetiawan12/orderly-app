...
export default function SellerReviewsPage() {
  ...
  const itemsPerPage = 6; // Maksimal 5 ulasan per halaman demi anti-melar
  
  const sellerId = 1; // 👈 Nanti bisa diganti pake id dari session user login lu
  ...
  useEffect(() => {
    ...
    const fetchReviews = async () => {
      try {
        const res = await fetch(`http://localhost:5000/api/products/seller/reviews/${sellerId}`);
        if (res.ok) {
        ...
        <div>
          ...
          <div className="px-6 py-6 mx-auto w-full max-w-full block box-border overflow-x-hidden">
            ...
            <div className="flex flex-wrap -mx-3 mb-6">
                    ...
                    <div className="flex flex-row -mx-3">
                     ...
                     <div className="px-3 text-right basis-1/3">
                       <div className="inline-block w-12 h-12 text-center rounded-circle bg-gradient-to-tl from-blue-500 to-violet-500">
                            {/* 👇 Ganti jadi fa fa-comment bray, auto nongol ikon chat box */}
                  ...
                  <div className="flex-auto p-4">
                    ...
                    <div className="px-3 text-right basis-1/3">
                        <div className="inline-block w-12 h-12 text-center rounded-circle bg-gradient-to-tl from-orange-500 to-yellow-500">
                            {/* 👇 Ganti ni jadi fa bray, biasanya langsung aktif */}
                    ...
                    <div className="flex flex-row -mx-3">
                      ...
                      <div className="px-3 text-right basis-1/3">
                        <div className="inline-block w-12 h-12 text-center rounded-circle bg-gradient-to-tl from-emerald-500 to-teal-400">
                            {/* 👇 Ganti jadi fa fa-smile bray, biar muncul ikon emot senyum puas */}
              ...
              {/* 🔥 Card 4: Persentase Kepuasan Pembeli (Biar Genap 4 Cards Anti Jomplang Layout) */}
              <div className="w-full max-w-full px-3 sm:w-1/2 sm:flex-none xl:w-1/4">
                    ...
                    <div className="flex flex-row -mx-3">
                      ...
                      <div className="px-3 text-right basis-1/3">
                        <div className="inline-block w-12 h-12 text-center rounded-circle bg-gradient-to-tl from-red-600 to-orange-600">
                            {/* 👇 Ganti jadi fa fa-thumbs-up bray */}
                ...
                {/* =========================================================================
                    📦 PEMBUNGKUS UTAMA: PAKAI FLEX-WRAP (Sama persis kayak barisan boks statistik lu)
                        Biar otomatis ID 1, 2, 3 ngalir ke kanan, lalu ID 4, 5, 6 baris bawahnya.
                    ========================================================================= */}
                        ...
                        >
                            ...
                            <div className="flex flex-row -mx-3 items-start">
                                ...
                                <div>
                                    ...
                                    "{rev.comment || <span className="text-slate-300">Hanya rating.</span>}"
                                    </p>
                                </div>
                                </div>
                                ...
                                <div className="inline-block w-12 h-12 rounded-circle bg-gradient-to-tl from-blue-500 to-violet-500 flex items-center justify-center p-1.5 shadow-sm">
                                    ...
                                    <img 
                                        src={rev.product_image ? `http://localhost:5000/uploads/products/${rev.product_image}` : 'https://placehold.co/100?text=No+Img'} 
                    ...
                    <div className="flex gap-1.5">
                        <button
                            ...
                            style={{
                                ...
                                /* 👇 Kondisi dikunci kalau lagi di halaman pertama (currentPage === 1) */
                        ...
                        <button
                            ...
                            style={{
                                ...
                                borderRadius: '6px', 
                                border: '1px solid #e2e8f0',
                                /* 👇 Di bawah ini udah gua ganti pakai variabel ulasan (reviews) semua ya bray */
